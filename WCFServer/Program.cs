...
using KMA.APZRP2019.AlarmClock.Server.WCFServer;
...
namespace KMA.APZRP2019.AlarmClock.Server.WCFServer
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            const string serviceName = AlarmClockWCFService.CurrentServiceName;
            ...
            {
                var servicesToRun = new ServiceBase[] { new AlarmClockWCFService(), };
